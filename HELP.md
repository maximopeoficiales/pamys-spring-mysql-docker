# Initials Commands
     docker-compose up -build  (crea la imagen del proyecto)
     docker-compose stop (detiene los contenedores del proyecto)
     docker-compose up (inicializa los contenedores del proyecto)
